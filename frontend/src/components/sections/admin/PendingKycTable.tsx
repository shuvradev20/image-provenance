...
import { ArrowRight, FileText, Clock, Copy, CopyCheck, Loader2 } from "lucide-react";
...
export function PendingKycTable() {
  ...
  if (!users || users.length === 0) {
    return (
      <div className="h-64 bg-card border border-dashed border-border rounded-xl flex flex-col items-center justify-center">
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        >
                          <span
                            style={{
                              color:
                                "var(--status-warning, oklch(0.75 0.15 65))",
                            }}
